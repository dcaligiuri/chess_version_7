...
class Game 
	...
	def play 
		...
		while true 
			...
			until piece_to_move.move(self.board, move_to_square) && current_player.color == piece_to_move.color && board.in_check?(current_player.color) == false &&
			current_player.valid_input(position_of_piece) && current_player.valid_input(move_to_square)
